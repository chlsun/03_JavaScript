...
btn2.addEventListener("click", ()=>{
  ...
  const [first, second, fhird] = fruits;

  console.log("first : ", first);
  console.log("second : ", second);
  console.log("fhird : ", fhird);
...
btn4.addEventListener("click", ()=>{
  ...
  const copy1 = obj;  //얕은 복사(copy1는 obj와 같은 객체 참조)
  ...
  /* 속성 덮어 쓰기 */
  const obj5 = {...copy3, phone:"01099998888"};
