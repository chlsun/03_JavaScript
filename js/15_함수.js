 ...
 * @param num : 전달 받은 숫자(매개변수 쓰임새를 설명하는 방법)
*/
...
btn2.addEventListener("click", ()=>{
  const inputs = document.getElementsByName("input2");
  const arr = [];
...
arrows[2].addEventListener("click", ()=>{
  ...
  const print = str => console.log(str);  // {} 생략 가능, ()도 생략 가능
...
/* function(){} 의 this 확인 */
const btn8 = document.querySelector("#btn8").addEventListener("click", function(){
  console.log(this);  // === 이벤트가 발생한 요소
}); 
/* () => {} 의 this 확인 */
const btn9 = document.querySelector("#btn9").addEventListener("click", ()=>{
