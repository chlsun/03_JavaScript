...
/*
  ...
  2) 이벤트가 발생된 요소 (화살표 함수 X => 화살표 함수 안에서 this는 window)
...
const studentList = [
  ...
  new Student(2,2,2,"김관민"),
  new Student(3,3,3,"김구남")
];
...
addStudent.addEventListener("click", ()=>{
  ...
  studentList.push(std);  //배열.push(값) : 배열 마ㅏ지막 요소로 추가
...
checkJson.addEventListener("click", ()=>{
  ...
  console.log("userJ", userJ, typeof userJ);
